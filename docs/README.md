# OWASP.WTF Documentation

Welcome. Pick a topic.

| Doc | What it covers |
|---|---|
| [Installation](./installation.md) | `npx`, global install, GitHub Action, from source |
| [Usage](./usage.md) | CLI commands, flags, output formats, exit codes |
